...
When an equation becomes too large to run in-line, you display it in a â€œMathâ€
paragraph by itself.
...
This is the $3^{\text{rd}}$ time Iâ€™ve asked for my money back.
...
Demonstrating `\left\{â€¦\right.` and accents.
